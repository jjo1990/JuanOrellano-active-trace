...
| **Frontend** | React / TanStack / Tailwind / E2E | `typescript-advanced-types`, `tailwind-design-system`, `dashboard-crud-page`, `help-system-content`, `playwright-best-practices` |
...
> **Gap conocido**: no hay skill de buenas prácticas React instalada (`vercel-react-best-practices` recomendada pero NO instalada por decisión del usuario). El stack queda cubierto ~100% por las skills preinstaladas. Las skills `dashboard-crud-page` y `help-system-content` se agregaron desde el zip de skills.
